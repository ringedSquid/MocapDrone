...
#ifndef __image_types_image_grey_t_hpp__
#define __image_types_image_grey_t_hpp__
...
class image_grey_t
{
    public:
        ...
        /**
         * Rows in image matrix
         */
        int32_t    cols;

        /**
         * Cols in image matrix
         */
        int32_t    size;
...
int image_grey_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int image_grey_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int image_grey_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t image_grey_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* image_grey_t::getTypeName()
{
    return "image_grey_t";
}

int image_grey_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int image_grey_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int image_grey_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t image_grey_t::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x152c660db32ca2d3LL;
